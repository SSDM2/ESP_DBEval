...
interface Exercice {
  id: number; // Unique identifier for each Exercice
  name: string; // Exercice name
  variants: string; // Number of variants (e.g., "1 Variant", "2 Variants")
  echeance: string; // echeance of the Exercice
  type: string; // type of the Exercice (as a string with currency symbol)
  // status: string; // Status of the Exercice
  image: string; // URL or path to the Exercice image
  file: string; // URL or path to the Exercice image
  correction: string; // URL or path to the Exercice image
  status: "corrige" | "en cours" | "indisponible"; // Status of the Exercice
  // action: string; // prolongee 
}

// Define the table data using the interface
const tableData: Exercice[] = [
  {
    id: 1,
...
export default function ExercicestList() {
