    ...
    <ComponentCard title="Formulaire de Soumission">
      <div className="space-y-6">
        <div className="flex flex-col items-center w-full gap-6 xl:flex-row">
          <div className="w-20 h-20 overflow-hidden border border-gray-200 rounded-md dark:border-gray-800">
            <img src="/images/exos/exo-01.png" alt="user" />
          </div>
        ...
        <div className="text-gray-500 bg-gray-50 p-4 rounded-md border-x-2 border-blue-800 dark:bg-gray-800">
          <div className="mb-2">
